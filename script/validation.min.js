...
try { let vaalForm = document.getElementsByClassName('vaal-form') || {}; for (let form of vaalForm) { let inputs = form.querySelectorAll('input'); let buttons = form.querySelectorAll('input[type=submit],button');
inputs = [...inputs];
inputs.reverse();
